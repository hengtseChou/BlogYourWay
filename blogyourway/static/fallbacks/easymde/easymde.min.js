          ...
          !(function (e, i) {
            ...
            (M.def = m(M.def)
              ...
              (M.list = m(M.list)
                ...
                .getRegex()),
              (M._tag =
                "address|post|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul"),
              (M._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/),
              (M.html = m(M.html, "i")
